...
void Render()
{
    ...
    g_pImmediateContext->PSSetConstantBuffers(0, 1, &g_pTransparentBuffer);
    ...
    if (blueDist >= greenDist)
    {
        ...
        g_pImmediateContext->UpdateSubresource(g_pTransparentBuffer, 0, nullptr, &blueColor, 0, 0);
        g_pImmediateContext->Draw(ARRAYSIZE(g_CubeVertices), 0);
        ...
        g_pImmediateContext->UpdateSubresource(g_pTransparentBuffer, 0, nullptr, &greenColor, 0, 0);
        g_pImmediateContext->Draw(ARRAYSIZE(g_CubeVertices), 0);
    }
    else
    {
